<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark " style="background-color:  #3c8dbc">
    ...
    <?php endif; ?>
      <li>
        <a class="nav-link text-white"  href="./index.php?page=home" role="button"> <large><b style="color:white;"><?php echo $_SESSION['system']['name'] ?></b></large></a>
      </li>
    </ul>
            ...
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)">
              <span>
                <div class="d-felx badge-pill">
                  ...
                  <span><b style="color:white;"><?php echo ucwords($_SESSION['login_firstname']) ?></b></span>
