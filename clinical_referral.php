...
<div class="row">
 <table class="table table-bordered table-striped table-responsive-stack"  id="tableOne">
      ...
      <tbody>
        <tr>
            <td width="50%" style="color:#CD853F;">
                <div class="row">
                    <div class="col-md-6">
           ...
           <p style="color:#CD853F; text-align: center;">
            Resident Status
               ...
               <tr style="height:35px;">
                ...
                <td>
                    <p style="font-size: 12px;"><input name="resident_status" type="radio" id="Exit1" <?php if (isset($resident_status) && $resident_status=="Yes") echo "checked";?> value="Exit" required></p>
                </td>
               </tr>
            </table>
            </p>
...
<script type="text/javascript">
        $(function () {
            $("input[name='clinical_referral']").click(function () {
                if ($("#clinical_referral1").is(":checked")) {
                     $("#outcome1").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='clinical_referral']").click(function () {
                if ($("#clinical_referral1").is(":checked")) {
                    $("#outcome2").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='clinical_referral']").click(function () {
                if ($("#clinical_referral1").is(":checked")) {
                    $("#outcome3").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='clinical_referral']").click(function () {
                if ($("#clinical_referral1").is(":checked")) {
                    $("#outcome4").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='clinical_referral']").click(function () {
                if ($("#clinical_referral1").is(":checked")) {
                    $("#app_date").attr("disabled", "disabled");
                }
            });
        });
    </script>
    ...
    <script type="text/javascript">
        $(function () {
            $("input[name='clinical_referral']").click(function () {
                if ($("#clinical_referral2").is(":checked")) {
        ...
        <tr>
            <td width="100%">
               <table>
                   ...
                   <tr>
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">Clinical Referral</p>
                           <table>
                ...
                <tr>
                    <td><input name="clinical_referral" type="radio" id="clinical_referral2" <?php if (isset($clinical_referral) && $clinical_referral=="Yes") echo "checked";?> value="Yes" required></td>
                    <td><input name="clinical_referral" type="radio" id="clinical_referral1" <?php if (isset($clinical_referral) && $clinical_referral=="No") echo "checked";?> value="No"  required></td>
                       ...
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">Hospital Name &nbsp;&nbsp; <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addIn" style="margin-left: 2px; font-size:8px;"><i class="fa fa-plus fa-fw"> </i></button></p>
                           <table>

                <tr>
                    <td><select class="form-control form-control-sm select2" name="hospital_name" id="hospital_name" required>
                <option></option>
                <?php 
                $regimen = $conn->query("SELECT * FROM hospital_name ORDER BY name ASC ");
                while($row= $regimen->fetch_assoc()):
                ?>
                <option value="<?php echo $row['name'] ?>" <?php echo isset($hospital_name) && $hospital_name == $hospital_name ? "selected" : '' ?>><?php echo ucwords($row['name']) ?></option>
                <?php endwhile; ?>
              </select></td>
                       ...
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">Outcome</p>
                           <table>
<tr>
                                   <td>
                    <p class="vericaltext" style="font-size: 12px;">Released</p>
                </td>

                <td>
                    <p class="vericaltext" style="font-size: 12px;">Transfered</p>
                </td>

            
                                <td>
                    <p class="vericaltext" style="font-size: 12px;">Died</p>
                </td>

                <td>
                    <p class="vericaltext" style="font-size: 12px;">Escape</p>
                </td>
                               </tr>
                ...
                <tr>
                    <td><input name="outcome" type="radio" id="outcome1" <?php if (isset($outcome) && $outcome=="Released") echo "checked";?> value="Released" required></td>
                    <td><input name="outcome" type="radio" id="outcome2" <?php if (isset($outcome) && $outcome=="Transfered") echo "checked";?> value="Transfered" required></td>
                    <td><input name="outcome" type="radio" id="outcome3" <?php if (isset($outcome) && $outcome=="Died") echo "checked";?> value="Died" required></td>
                    <td><input name="outcome" type="radio" id="outcome4" <?php if (isset($outcome) && $outcome=="Escape") echo "checked";?> value="Escape" required></td>
                       ...
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">Next App/Outcome Date</p>
                           <table>
                <tr>
                    <td><input name="app_date" id="app_date" type="date" value="<?php echo isset($app_date) ? date("Y-m-d",strtotime($visit_date)) : '' ?>" style="width: 100%;"></td>
...
function redirect() {
    ...
    if (ask) {
       // window.alert("You Have Been Successfully Redirected!");
        ...
        window.location.href = "./index.php?page=clinical_referral";
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == 1){
                    ...
                    setTimeout(function(){
                        location.href = 'index.php?page=clinical_referral'
                    },2000)
                }
            }
        })
