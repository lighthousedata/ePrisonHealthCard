...
<div class="row">
 ...
 <p style="color:#CD853F; text-align: center;">
               Prisoners Number</p>
                ...
                <?php endwhile; ?>
                    ...
                    <div class="col-md-6">
                     <p style="color:#CD853F; text-align: center;">
            Date Issued </p>
            <input type="date" name="date_issued" value="<?php echo isset($date) ? date("Y-m-d",strtotime($date)) : '' ?>" required style="width:100%; border-radius:5px;">
    ...
    <tr>
         <td>
                <p style="color:#CD853F; text-align: center;">Quantity And Description</p>

                <textarea name="quantity_and_description" style="float: right; border-radius: 5px; border-bottom-color: #CD853F; width:100%;" required>
                    <?php echo isset($quantity_and_description) ? $quantity_and_description : '' ?>
                </textarea>
...
<script>
    $('#manage-project').submit(function(e){
        ...
        start_load()
        $.ajax({
            url:'ajax.php?action=save_prison_issuances',
            ...
            success:function(resp){
                if(resp == 1){
                    ...
                    setTimeout(function(){
                        location.href = 'index.php?page=prison_issuances'
                    },2000)
                }
            }
        })
