    ...
    <div class="col-md-12">
        <div class="card card-outline card-secondary">
            <div class="card-header">
                <b style="text-align: center;">Addimitted Today</b>
            </div>
            ...
            <div class="card-body p-0">
                ...
                if($_SESSION['login_type'] == 3 || $_SESSION['login_type'] == 2 || $_SESSION['login_type'] == 4){
                 ...
                 $qry = $conn->query("SELECT p.*, concat(p.fname, ' ', p.lname) AS pname, r.name AS region_name, s.name AS station_name FROM prisoners p INNER JOIN regions r ON r.id = p.regions_id INNER JOIN stations s ON s.id = p.stations_id  WHERE p.stations_id = $stations_id AND p.status = 1 AND  DATE(p.created_at) = CURDATE() ORDER BY prisoners_no ASC");
                  ...
                  ?>
                      ...
                      ?>
                                ...
                                <td class="text-center">
                                    <button type="button"
                                        class="btn btn-default btn-sm btn-flat border-secondary wave-effect text-info dropdown-toggle"
                                    ...
                                    <div class="dropdown-menu" style="">
                                        ...
                                        <a class="dropdown-item view_prison_data" href="#&id=<?php echo $row['id'] ?>"
