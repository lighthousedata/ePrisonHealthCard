...
?>
                ...
                ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            style="border-radius: 5px; width:100%; height: 33px;"
                                            value="<?php echo isset($item) ? $item : '' ?>" required>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            style="border-radius: 5px; width:100%; height: 33px;"
                                            value="<?php echo isset($bag_number) ? $bag_number : '' ?>" required>
...
$('#manage-project').submit(function(e) {
    ...
    start_load()
    $.ajax({
        url: 'ajax.php?action=save_batchings',
        ...
        success: function(resp) {
            if (resp == 1) {
                ...
                setTimeout(function() {
                    location.href =
                        'index.php?page=batching_and_baggage_of_prisoner_belongings_and_personal_effects'
                }, 2000)
            }
        }
    })
