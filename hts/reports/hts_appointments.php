    ...
    <div class="col-md-12">
        <div class="card card-outline card-secondary">
            <div class="card-header">
                <b style="text-align: center;">HTS Appointments</b>
            </div>
            ...
            <div class="card-body p-0">
                ...
                // if($_SESSION['login_type'] == 3 || $_SESSION['login_type'] == 2 || $_SESSION['login_type'] == 4){
                 ...
                 $qry = $conn->query("SELECT p.*, concat(p.fname, ' ', p.lname) AS pname, r.name AS region_name, s.name AS station_name FROM prisoners p INNER JOIN hiv_test h ON h.prisoners_no = p.id INNER JOIN regions r ON r.id = p.regions_id INNER JOIN stations s ON s.id = p.stations_id  where app_date = current_date() ORDER BY prisoners_no ASC;");
