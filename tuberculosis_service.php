            ...
            if ($counter == 1) 
              { 
                ...
                <script type = "text/javascript">
                    ...
                    window.location = "index.php?page=tuberculosis_service";
                </script>
               ...
               Prisoners Number<br><br><br>
                ...
                <?php endwhile; ?>
                    ...
                    <div class="col-md-6">
                     <p style="color:#CD853F; text-align: center;">
            Visit Date: <br><br><br>
            <input type="date" value="<?php echo isset($visit_date) ? date("Y-m-d",strtotime($visit_date)) : '' ?>" name="visit_date" required>
            </p>   
                    </div>
...
<script type="text/javascript">
        $(function () {
            $("input[name='tb_screening']").click(function () {
                if ($("#tb_screening2").is(":checked")) {
                    $("#test_criteria").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='tb_screening']").click(function () {
                if ($("#tb_screening2").is(":checked")) {
                    $("#test_criteria1").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='tb_screening']").click(function () {
                if ($("#tb_screening2").is(":checked")) {
                     $("#tb_test").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='tb_screening']").click(function () {
                if ($("#tb_screening2").is(":checked")) {
                    $("#tb_test1").attr("disabled", "disabled");
                }
            });
        });
    </script>
...
<script type="text/javascript">
        $(function () {
            $("input[name='tb_screening']").click(function () {
                if ($("#tb_screening2").is(":checked")) {
                    $("#tb_test2").attr("disabled", "disabled");
                }
            });
        });
    </script>
        ...
        <tr>
            <td width="33.33%">
               <table>
                   ...
                   <tr>
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">TB Screening</p>
                           <table>
                ...
                <tr>
                    <td><input name="tb_screening" type="radio" id="tb_screening3" <?php if (isset($tb_screening) && $tb_screening=="Not Presumptive") echo "checked";?> value="Not Presumptive" required></td>
                    <td><input name="tb_screening" type="radio" id="tb_screening1" <?php if (isset($tb_screening) && $tb_screening=="Presumptive") echo "checked";?> value="Presumptive" required></td>
                    <td><input name="tb_screening" type="radio" id="tb_screening2" <?php if (isset($tb_screening) && $tb_screening=="Not Done") echo "checked";?> value="Not Done" required></td>
                       ...
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">Test Criteria</p>
                           <table>
                ...
                <tr>
                    <td><input name="test_criteria" type="radio" id="test_criteria"  <?php if (isset($test_criteria) && $test_criteria=="New Test") echo "checked";?> value="New Test" required></td>
                    <td><input name="test_criteria" type="radio" id="test_criteria1" <?php if (isset($test_criteria) && $test_criteria=="Re-Test") echo "checked";?> value="Re-Test"  required></td>
                       ...
                       <td width="33.33%">
                           <p style="text-align:center;color:#CD853F;">TB Testing</p>
                           <table>
<tr>
                                   <td>
                ...
                <tr>
                    <td><input name="tb_test" type="radio" id="tb_test"  <?php if (isset($tb_test) && $tb_test=="Negative") echo "checked";?> value="Negative" required></td>
                    <td><input name="tb_test" type="radio" id="tb_test1"  <?php if (isset($tb_test) && $tb_test=="Positive") echo "checked";?> value="Positive" required></td>
                    <td><input name="tb_test" type="radio" id="tb_test2"  <?php if (isset($tb_test) && $tb_test=="Unknown") echo "checked";?> value="Unknown" required></td>
            ...
            <option></option>
            <?php 
            $regimen = $conn->query("SELECT * FROM tb_test_type ORDER BY name ASC ");
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == 1){
                    ...
                    setTimeout(function(){
                        location.href = 'index.php?page=tuberculosis_service'
                    },2000)
                }
            }
        })
